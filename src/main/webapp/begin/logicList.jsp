...
<head>
	...
	$(document).ready(function() {
		...
		$('#gridList').on('click', '.setGridFn', function() {
			location.href = '/begin/logicChangeList?CLASS_ID='+$(this).data('class_id')+'&CLASS_TITLE='+$(this).data('class_title');
		});

		$('#gridList').on('click', '.changeBtn', function() {
			location.href = '/begin/logicStep?CLASS_ID='+$(this).data('class_id')+'&AGC_ID='+$(this).data('agc_id');
		});
		...
		$('.regBtn').on('click', function() {
			...
			location.href = '/begin/logicStep?AGC_ID='+gAgcId;
		});
						...
						if(data.list.length > 0) {
							$.each(data.list, function(index, item) {
								_html += '<tr class="items" data-class_id="'+item.CLASS_ID+'"  data-agc_id="'+item.AGC_ID+'"   onclick="SetBackgroundColor(this)">'+
											...
											'<td class="t_left"><a href="javascript:void(0);" class="setGridFn" data-class_id="'+item.CLASS_ID+'" data-class_title="'+item.CLASS_TITLE+'">'
								if (item.CD_ADD_STATE=="4") {
									_html += '['+ item.CD_ADD_STATE_NAME + ']';
								}
								_html +=	' ' +item.CLASS_TITLE+'</a></td>'+
						...
						<div class="conBox">
							...
							<div class="con_form">
								<table class="tbl_ty3 schTb">
									...
									<tr>
										<td>
											<input class="tbl_input wd100"  id="AGC_NAME" name="AGC_NAME"/>
										</td>
										<td>
										...
										<td>
											<input type="text" class="tbl_input wd225" id="CLASS_TITLE" name="CLASS_TITLE"/>
										</td>
										<td>
						...
						<div class="conBox">
							...
							<div class="con_form">
								<table class="tbl_ty3">
									...
									<tr>										
										<td>
											<input type="date" class="tbl_date"  id="S_WRITED_DATE" name="S_WRITED_DATE"/>
										</td>
										<td>
											<input type="date" class="tbl_date"  id="E_WRITED_DATE" name="E_WRITED_DATE"/>
										</td>
										<td>
											<input type="text" class="tbl_input" id="CLASS_TITLE" name="CLASS_TITLE"/>
										</td>
										
										<td>
											<input type="date" class="tbl_date"  id="S_CHNG_DATE" name="S_CHNG_DATE"/>
										</td>
										<td>
											<input type="date" class="tbl_date"  id="E_CHNG_DATE" name="E_CHNG_DATE"/>
										</td>
									</tr>									
								</table>
