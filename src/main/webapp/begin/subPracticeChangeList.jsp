...
<head>
	...
	$(document).ready(function() {
		...
		$('#gridList').on('click', '.setGridFn', function() {
			location.href = '/begin/subPracticeChangeList?CHNG_ID='+$(this).data('chng_id');
		});
	...
	function getSubPracticeChangeList(index) {

		_CLASS_ID = "${CLASS_ID}";

		var params = {
				'class' : 'service.BeginService',
				'method' : 'getSubPracticeChangeList',
				'param' : {
					'CLASS_ID' : _CLASS_ID
				},
					...
					if(data.success){
						...
						if(data.list.length > 0) {
							$.each(data.list, function(index, item) {
								...
								'<td><a href="javascript:void(0);" class="reply_btnsetGridFn" data-class_id="'+item.CLASS_ID+'">보기</a></td>'+
