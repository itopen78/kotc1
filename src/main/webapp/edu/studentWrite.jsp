		...
		$('.studentSave').on('click', function() {
			...
			var params = {
					...
					'param' : {
						...
						, 'LICENSE_SERIAL' : $('#LICENSE_SERIAL').val()
						...
						, 'STU_NOTE' : $('#STU_NOTE').val()
					},
					'callback' : function(data){
						if(data.success){
							loadingStop();
							alert('저장 되었습니다.');
							location.href='/edu/studentList';
						}
					}
			};
			apiCall(params);
		...
		var params = {
				...
				'callback' : function(data){
					if(data.success){
						...
						$('#CD_CLASS_TYPE').val(studentDetail.CD_CLASS_TYPE);
					...
					<div class="sub_con">
						...
						<div class="main_btn">
							<ul>
								...
								<li class="page_ok"><a href="javascript:void(0);" class="studentSave">저장</a></li>
							</ul>
						</div>
					</div>
				</div>
